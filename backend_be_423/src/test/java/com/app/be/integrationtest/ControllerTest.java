...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM be_426.FundingRound");
    jdbcTemplate.execute("DELETE FROM be_426.Stage");
    jdbcTemplate.execute("DELETE FROM be_426.Document");
    jdbcTemplate.execute("DELETE FROM be_426.Investor");
    jdbcTemplate.execute("DELETE FROM be_426.Founder");
    jdbcTemplate.execute("DELETE FROM be_426.Startup");
     jdbcTemplate.execute("DELETE FROM be_426.StartupFounders");
     jdbcTemplate.execute("DELETE FROM be_426.StartupKeyMetrics");
     jdbcTemplate.execute("DELETE FROM be_426.InvestorInvestmentPreferences");
     jdbcTemplate.execute("DELETE FROM be_426.StartupPreviousRounds");
     jdbcTemplate.execute("DELETE FROM be_426.FundingRoundInvestors");
